...
const Nav = ({ shopItems, setShopItems, shopCount }) => {
      ...
      <nav style={navStyle}>
        ...
        <ul className="nav-list">
          <li className="nav-list-item">
            <Link to="#" className="list-item" onClick={toggleDropdown}>
              選擇香氣
            </Link>
            <ul
              className={`hide-prod ${isActive ? "active" : ""}`}
              ref={hideProdRef}
            >
              <li>
                <Link to="/prod" className="dream">
                  夢幻花境
                </Link>
              </li>
              <li>
                <Link to="/prod-summer" className="summer">
                  夏日晴空
                </Link>
              </li>
              <li>
                <Link to="/prod-soul" className="forest">
                  幽林冒險
                </Link>
              </li>
            </ul>
          </li>
          <li className="nav-list-item" ref={celebrityRecommendationRef}>
          ...
          <li className="nav-list-item">
            <Link to="/shops" className="list-item">
              櫃點資訊
            </Link>
          </li>
          <li className="nav-list-item">
        ...
        <div className="nav-list-item-icons">
          <ul>
            <li>
              <Link to="/shopping" className="shoppingBag">
                {shopCount && <p className="shop-count">{shopCount}</p>}
                <img src="./images/icon-shoppingBag.svg" alt="" />
              </Link>
            </li>
            <li>
              <Link to="/member">
