        ...
        <div>
            <body className="scrollBox">
                ...
                <section className="brand-info">
                    ...
                    <div className="brand-info-img1"><img src="./images/brand-info-img1.jpg" alt="" /></div>
                    ...
                    <div className="brand-info-img2"><img src="./images/brand-info-concept-.jpg" alt="" /></div>
                    <div className="brand-info-img3"><img src="./images/brand-info-show.jpg" alt="" /></div>
                </section>
            </body>
        </div>
